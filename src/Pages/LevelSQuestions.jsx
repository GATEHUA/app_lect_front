      ...
      <div className=" fixed top-0 right-0 p-5">
        ...
        >
          <div className="flex px-3 justify-center items-center space-x-2 hover:bg-[rgba(0,0,0,0.05)] h-full rounded-lg">
            ...
            <p className="hidden lg:block">Producto Creativo</p>
          </div>
        </ButtonTouch>
      </div>
      <div className="w-full min-h-screen h-full dark:bg-slate-800 dark:text-white font-Poppins overflow-auto">
        <div className=" flex h-[84vh] mt-16 ">
          {getList(null).length > 0 && (
            <>
              <div
                className="w-1/3 flex flex-col p-4 overflow-auto space-y-3 bg-transparent border border-white m-4 rounded-lg"
                onDragOver={dragOver}
          ...
          <div className="w-full grid grid-cols-2 gap-4 p-4 ">
            {Array.from({ length: 4 }, (_, index) => (
              <div
                key={index}
                className="bg-transparent border border-white rounded-lg p-2 overflow-auto space-y-1"
                onDragOver={dragOver}
        ...
        {drag.current == true && (
          <div className="flex justify-center">
            <ButtonTouch
              ...
              className={`w-[950%] h-10 text-lg rounded-lg bottom-0 mx-8  text-[#52656d]"
                         bg-[#58cc02]
                      }`}
            >
